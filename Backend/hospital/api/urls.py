...
urlpatterns=[
    ...
    path('user/Appointments/',views.UserAppointmentsView.as_view(),name='userappointment'),
    ...
    path('doctor/Appointments/',views.DoctorAppointmentsView.as_view(),name='doctorappointment'),
